...
public class HttpFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    private final static String CONTENT_TYPE = io.netty.handler.codec.http.HttpHeaders.Names.CONTENT_TYPE;
    private final static String LOCATION = io.netty.handler.codec.http.HttpHeaders.Names.LOCATION;
    private final static String CONNECTION = io.netty.handler.codec.http.HttpHeaders.Names.CONNECTION;
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest request)
         ...
         */
        if(isKeepAlive(request)){//判断是否是keepalive,如果是就设置消息头connection为keep-alive
